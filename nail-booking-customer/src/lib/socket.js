// Socket.IO client for the customer app — one shared connection for the
// whole app. Replaces the old Firestore onSnapshot / 8-second poll: the
// backend pushes catalog/booking updates the moment anything changes
// (a service edited by the owner, another customer taking a slot, the
// owner confirming this booking), so pages never need a manual refresh.
